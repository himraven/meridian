...
SOURCES = [
    ...
    # ── US Smart Money (rsnest crons → /app/data/) ──
    {
        ...
        "max_age_hours": 20,    # 3x daily: 13:00, 18:00, 23:00 UTC → max gap 19h (23→18 next day)
                                # congress.json only updates when new filings found; use 20h threshold
    ...
    },
    {
        ...
        "path": "/app/data/ark_changes.jsonl",   # rsnest ark collector writes here
    ...
    },
    {
        ...
        "path": "/app/db/trend_cache.json",      # auto-generated by trend_filter (writable /app/db/)
        "max_age_hours": 96,
